...
export function CourseEditor({ course, topicIds = [], instructorIds = [], topics, instructors, currentUserId }: Props) {
  ...
  const [coverPreview, setCoverPreview] = useState<string | null>(getCourseCoverUrl(course?.cover_path ?? null));
